...
do shell script "cp -Rfp " & path_ & "/PyeTV.frappliance /System/Library/CoreServices/Front\\ Row.app/Contents/PlugIns" with administrator privileges

--copy icon from EyeTV application
try
  do shell script "cp /Applications/EyeTV.app/Contents/Resources/eyetv.icns /System/Library/CoreServices/Front\\ Row.app/Contents/PlugIns/PyeTV.frappliance/Contents/Resources/ApplianceIcon.png" with administrator privileges
on error
